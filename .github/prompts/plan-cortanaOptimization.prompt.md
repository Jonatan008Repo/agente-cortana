...
Conservar personalidad de Cortana, ampliar con ejemplos más relevantes y técnicos de desarrollo web más útiles.
...
**Archivos relevantes**
- [src/Cortana.agent.md](src/Cortana.agent.md): flujo SDD, identidad, stack, reglas operativas y commits.
- [README.md](README.md): documentación de entrada y guía de uso.
